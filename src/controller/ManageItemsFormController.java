...
//            ResultSet rst = stm.executeQuery("SELECT * FROM Item");
            ...
            for (ItemDTO e : allItem) {
                    tblItems.getItems().add(new ItemTM(e.getCode(), e.getDescription(), e.getUnitPrice(), e.getQtyOnHand()));
            }
...
//
                ...
                boolean isSave = itemDAOImpl.save(itemDTO);
                if (isSave) {
...
//                pstm.executeUpdate();
                ...
                boolean isUpdate = itemDAOImpl.update(itemDTO);
                if (isUpdate) {
